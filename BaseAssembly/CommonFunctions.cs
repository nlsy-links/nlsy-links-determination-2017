...
namespace Nls.BaseAssembly {
	public static class CommonFunctions {
		...
		//   }
		//}
		public static byte LastTwoDigitsOfGen2SubjectID ( LinksDataSet79.tblSubjectRow drSubject ) {
		...
		public static Int16[] CreateExtendedFamilyIDs ( LinksDataSet79 dsLinks ) {
		...
		internal static bool BothGen1 ( LinksDataSet79.tblSubjectRow drSubject1, LinksDataSet79.tblSubjectRow drSubject2 ) {
