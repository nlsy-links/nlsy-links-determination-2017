...
PrintMarginalTable(dsJoint=dsLatest, relationshipPathID=1, title="Counts for 97 Housemates")
PrintMarginalTable(dsJoint=dsPrevious, relationshipPathID=1, title="Counts for 97 Housemates (Previous version of links)")
