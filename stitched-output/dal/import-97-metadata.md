...
study                     <- "97"
shallow_only              <- FALSE   # If TRUE, update only the metadata tables that won't delete any other database tables.
...
## # ... with 21 more rows, and 1 more variable: space_used_kb <int>
```
...
##  2     2 extended_famil~        1              1     9022 T      <NA>     
##  3     3 hh_internal_id         1              1        5 T      <NA>     
##  4    10 gender                 1              1        2 T      <NA>     
##  5    11 DateOfBirthMon~        1              1       12 T      <NA>     
##  6    12 DateOfBirthYear     1980           1980     1984 T      <NA>     
##  7    13 cross_sectiona~        0              0        1 T      <NA>     
##  8    14 race_cohort            1              1        4 T      race-eth~
##  9    20 InterviewDateD~    -   7              1       31 T      <NA>     
## 10    21 InterviewDateM~    -   7              1       12 T      <NA>     
## # ... with 16 more rows
## # A tibble: 6 x 4
...
##  9     9            18            18    62        1  0.250       0.250
## 10    10            19            19     8        1  0.250       0.250
...
```
## `import-97-metadata.R` file completed by `Will` at 2018-02-13, 14:01 -0600 in 2 seconds.
```
...
##  [5] hms_0.4.1        odbc_1.1.5       tidyselect_0.2.3 bit_1.1-12      
##  [9] testit_0.7.1     R6_2.2.2         rlang_0.1.6.9003 stringr_1.2.0   
## [13] blob_1.1.0       dplyr_0.7.4.9000 tools_3.4.3      checkmate_1.8.5 
## [17] utf8_1.1.3       cli_1.0.0        DBI_0.7          yaml_2.1.16     
## [21] bit64_0.9-7      assertthat_0.2.0 tibble_1.4.2     crayon_1.3.4    
## [25] purrr_0.2.4      readr_1.1.1      tidyr_0.8.0      RODBC_1.3-15    
## [29] evaluate_0.10.1  glue_1.2.0       stringi_1.1.6    compiler_3.4.3  
## [33] pillar_1.1.0     backports_1.1.2  pkgconfig_2.0.1
```
