...
```
## File completed by `Will` at 2018-01-12, 17:09 -0600 in 21 seconds.
```
...
## [17] DBI_0.7          htmltools_0.3.6  rprojroot_1.3-2  digest_0.6.13   
## [21] yaml_2.1.16      bit64_0.9-7      assertthat_0.2.0 tibble_1.4.1    
## [25] crayon_1.3.4     purrr_0.2.4      readr_1.1.1      tidyr_0.7.2     
## [29] RODBC_1.3-15     glue_1.2.0       evaluate_0.10.1  rmarkdown_1.8   
## [33] stringi_1.1.6    compiler_3.4.3   pillar_1.0.1     backports_1.1.2 
## [37] markdown_0.8     pkgconfig_2.0.1
```
